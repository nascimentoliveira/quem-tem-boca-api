...
/**
 * Drink Unprocessable Entity Response DTO
 *
 * This DTO represents a response for an Unprocessable Entity error related to a drink.
 ...
 * }
 */
export class DrinkUnprocessableEntityResponseDTO {
  /**
